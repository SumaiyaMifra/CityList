...
public class CityListTest {
     ...
     * as jessore is not there will be false
     * getcity returns sorted citylist
     */
    @Test
    ...
    {
        CityList cityList = new CityList();
        City city1 = new City("ZZZfghjk", "CD");
        cityList.add(city1);
    ...
    public void testgetprovince()
    {
        ...
        assertEquals(0, city.compareTo(cityList.getCities(7).get(1)));
        assertEquals(0, city1.compareTo(cityList.getCities(7).get(0)));
    }
}
